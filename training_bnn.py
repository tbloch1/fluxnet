...
for epoch in range(n_epochs):
    ...
    error_report = (((valpred-yval)**2)/yval)

    if devstr == 'cuda':
        wandb.log({'Epoch': epoch,
                    "Train Loss": loss_report.max().data.cpu().numpy(),
                    "Val Loss": valloss.mean().data.cpu().numpy(),
                    "Val RSE max": error_report.max().data.cpu().numpy(),
                    "Val RSE median": error_report.median().data.cpu().numpy(),
                    "Test Loss": testloss.mean().data.cpu().numpy(),
                    "Val RSE E1 mean": error_report[0].mean().data.cpu().numpy(),
                    "Val RSE E2 mean": error_report[1].mean().data.cpu().numpy(),
                    "Val RSE E3 mean": error_report[2].mean().data.cpu().numpy(),
                    "Val RSE E4 mean": error_report[3].mean().data.cpu().numpy(),
                    "Val RSE E5 mean": error_report[4].mean().data.cpu().numpy(),
                    "Val RSE E6 mean": error_report[5].mean().data.cpu().numpy(),
                    "Val RSE E7 mean": error_report[6].mean().data.cpu().numpy(),
                    "Val RSE E8 mean": error_report[7].mean().data.cpu().numpy(),
                    "Val RSE E9 mean": error_report[8].mean().data.cpu().numpy(),
                    "Val RSE E10 mean": error_report[9].mean().data.cpu().numpy(),
                    "Val RSE E11 mean": error_report[10].mean().data.cpu().numpy()})
    else:
        wandb.log({'Epoch': epoch,
                    "Train Loss": loss_report.max().data.numpy(),
                    "Val Loss": valloss.mean().data.numpy(),
                    "Val RSE max": error_report.max().data.numpy(),
                    "Val RSE median": error_report.median().data.numpy(),
                    "Test Loss": testloss.mean().data.numpy(),
                    "Val RSE E1 mean": error_report[0].mean().data.numpy(),
                    "Val RSE E2 mean": error_report[1].mean().data.numpy(),
                    "Val RSE E3 mean": error_report[2].mean().data.numpy(),
                    "Val RSE E4 mean": error_report[3].mean().data.numpy(),
                    "Val RSE E5 mean": error_report[4].mean().data.numpy(),
                    "Val RSE E6 mean": error_report[5].mean().data.numpy(),
                    "Val RSE E7 mean": error_report[6].mean().data.numpy(),
                    "Val RSE E8 mean": error_report[7].mean().data.numpy(),
                    "Val RSE E9 mean": error_report[8].mean().data.numpy(),
                    "Val RSE E10 mean": error_report[9].mean().data.numpy(),
                    "Val RSE E11 mean": error_report[10].mean().data.numpy()})
